<!doctype html>
<html class='no-js <?=$html_class?>' lang='<?=$lang?>'>
<head>
<meta charset='utf-8'/>
...
<?php if ($this->views->hasContent('aboveheader')) : ?>
<div id='wrap-aboveheader'>
    <div id='aboveheader'><?php $this->views->render('aboveheader')?></div>
</div>
<?php endif; ?>
...
<?php if ($this->views->hasContent('footer-column-1', 'footer-column-2', 'footer-column-3', 'footer-column-4')) : ?>
