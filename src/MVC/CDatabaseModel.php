...
class CDatabaseModel implements \Anax\DI\IInjectionAware
{
    ...
    /**
    * Order the database rows according to given condition
    *
    ...
    */
    ...
    /**
    * Return the id last inserted to database
    *
    * @return id of last inserted row in database
    */
